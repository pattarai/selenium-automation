...
## Please make sure you are assigned to an [Issue](https://github.com/pattarai/selenium-automation/issues) before submitting a pull request

Go to the [issue](https://github.com/pattarai/selenium-automation/issues) page and either
...
```
git remote add upstream https://github.com/pattarai/selenium-automation.git
